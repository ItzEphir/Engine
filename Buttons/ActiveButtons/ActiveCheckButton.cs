...
namespace Engine
{
    public class ActiveCheckButton : CheckButton
    {
        Color activeColor;
        Color activeColorTitle;

        public ActiveCheckButton(Vector2f Resolution, Vector2f OriginalResolution, string message, Vector2f coords, Vector2f size,
